...
public class ExtrasEvents extends ExtrasEventMethods {
	...
	private boolean movingxplus = false, movingxminus = false, movingzplus = false,
	movingzminus = false, filesCreated = false;
	private double x = 0, z = 0, offsetx = 0, offsetz = 0, pitch = 0, oldx = 0,
	oldz = 0;
